...
// import { ChevronDownIcon } from '@heroicons/react/outline'; // Outline icons
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <Image
                            ...
                            src="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/p/f/f/s-tsrt-catalog-03-kajaru-original-imagqktmfsngyvsg.jpeg?q=70"
                            width={200}
                            height={100}
                        />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex justify-start mt-2">
                                    <button className="flex text-black bg-yellow-400 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded" onClick={()=>addToCart({id})}>Add To Cart</button>
